...
/**
 * Handles composition of attributes within a specific context.
 *
 * <p>Each context type (part-composite, equipment-composite, upgrade, etc.) has its own
 ...
 * <pre>
 * public class PartCompositeHandler implements AttributeContextHandler {
 *     {@literal @}Override
 ...
 * </pre>
 */
public interface AttributeContextHandler {

	/**
	 * The context identifier this handler processes.
	 *
	 * @return The context identifier (e.g., "forgero:part-composite")
	 */
	OpenIdentifier contextId();
	 ...
	 *
	 * <p>The returned attributes are "resolved"—they no longer have a context and are ready
	 * for the next stage of processing or final resolution.</p>
	 *
	 * @param sources Named sources of attributes to compose
	 * @return Composed attributes (typically with no context, ready for propagation)
	 */
