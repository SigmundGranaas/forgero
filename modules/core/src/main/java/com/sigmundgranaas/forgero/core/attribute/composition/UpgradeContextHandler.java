...
/**
 * Handles attributes with the "upgrade" context.
 *
 ...
 */
public class UpgradeContextHandler implements AttributeContextHandler {

	public static final UpgradeContextHandler INSTANCE = new UpgradeContextHandler();
	...
	public OpenIdentifier contextId() {
		return AttributeContext.UPGRADE;
	}
