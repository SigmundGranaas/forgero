...
public class SchematicCodecs {
	...
	public static Codec<SchematicData> create(Codec<List<AttributeData>> attributeCodec) {
		return RecordCodecBuilder.create(instance ->
				...
				).apply(instance, (type, name, include, tags, localTags, host, attributes, localAttributes, target, properties) ->
						new SchematicData(type, name, include.orElse(null), tags.orElse(null), localTags.orElse(null), host.orElse(null), attributes.orElse(null), localAttributes.orElse(null), target.orElse(null), properties.orElse(null))));
	}
}
