...
/**
 * Handles attributes with the "local" scope.
 *
 ...
 */
public class LocalScopeHandler implements AttributeScopeHandler {

	public static final LocalScopeHandler INSTANCE = new LocalScopeHandler();
	...
	public List<Attribute> compose(Map<String, List<Attribute>> sources) {
		...
		// Convert to resolved attributes (remove scope since they're now processed)
