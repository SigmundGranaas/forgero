...
/**
 * Handles composition of attributes in the part-composite scope.
 *
 ...
 * </pre>
 */
public class PartCompositeScopeHandler implements AttributeScopeHandler {

	public static final PartCompositeScopeHandler INSTANCE = new PartCompositeScopeHandler();

	@Override
	public OpenIdentifier scopeId() {
		return AttributeScope.PART_COMPOSITE;
	}
	...
	private boolean isMultiplierOperator(Operator op) {
		...
		// Multiplication is order 2, Division is order 3
		return op.order() >= 2;
	}
