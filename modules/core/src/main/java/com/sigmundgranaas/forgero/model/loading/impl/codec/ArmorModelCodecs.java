...
public class ArmorModelCodecs {
	...
	public static final Codec<ArmorModelDTO> ARMOR_MODEL_DTO_CODEC = RecordCodecBuilder.create(instance -> instance.group(
			...
			Codec.list(ModelCodecs.LAYER_DTO_CODEC).optionalFieldOf("textures", Collections.emptyList()).forGetter(ArmorModelDTO::textures),
	...
	).apply(instance, (id, type, model, textures, slots, target, context) -> new ArmorModelDTO(id.orElse(null), type ,model, textures, slots, target.orElse(null), context.orElse(null))));
}
