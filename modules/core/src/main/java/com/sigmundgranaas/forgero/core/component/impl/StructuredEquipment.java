...
public record StructuredEquipment(
	...
	public static StructuredEquipment create(
		...
		StructuredEquipment temp = new StructuredEquipment(id, tags, properties, structure, CompiledProperties.EMPTY);
		return new StructuredEquipment(id, tags, properties, structure, ComponentCompiler.compile(temp));
	}
	...
	public Component withStructure(ComponentStructure newStructure) {
		StructuredEquipment temp = new StructuredEquipment(this.id, this.tags, this.properties, newStructure, CompiledProperties.EMPTY);
		return new StructuredEquipment(this.id, this.tags, this.properties, newStructure, ComponentCompiler.compile(temp));
	}
	...
	public Component withProperties(Map<String, List<?>> newProperties) {
		...
		StructuredEquipment temp = new StructuredEquipment(this.id, this.tags, merged, this.structure, CompiledProperties.EMPTY);
		return new StructuredEquipment(this.id, this.tags, merged, this.structure, ComponentCompiler.compile(temp));
	}
}
