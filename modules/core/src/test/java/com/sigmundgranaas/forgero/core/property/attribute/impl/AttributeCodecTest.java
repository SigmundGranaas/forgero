...
class AttributeCodecTest {
	...
	void decodeSimpleAttributeWithDefaults() {
		String inputJson = """
            ...
            """;
		SimpleAttribute expected = new SimpleAttribute(Optional.empty(), ATTACK_DAMAGE, 10.0f, AdditionOperator.getInstance(), 0, Optional.empty(), Optional.empty());
	...
	void decodeSimpleAttributeWithExplicitValues() {
		...
		String inputJson = """
            ...
            """;
		SimpleAttribute expected = new SimpleAttribute(Optional.empty(), ATTACK_DAMAGE, 1.5f, MultiplicationOperator.getInstance(), 2, Optional.empty(), Optional.empty());
		assertDecode(inputJson, expected);
	}
	...
	void decodeSimpleAttributeWithLongOperatorName() {
		...
		SimpleAttribute expected = new SimpleAttribute(Optional.empty(), ATTACK_DAMAGE, 1.5f, SubtractionOperator.getInstance(), 0, Optional.empty(), Optional.empty());
		assertDecode(inputJson, expected);
	}
