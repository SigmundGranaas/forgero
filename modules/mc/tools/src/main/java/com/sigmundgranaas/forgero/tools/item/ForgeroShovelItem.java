 ...
 */
public class ForgeroShovelItem extends ShovelItem implements ForgeroHostItem {
	private final Component component;

	public ForgeroShovelItem(ToolMaterial material, Settings settings, Component component, Resolver resolver) {
