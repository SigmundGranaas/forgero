...
public class SimilarBlockFilter implements BlockFilter {
	private final Logger LOGGER = LoggerFactory.getLogger(SimilarBlockFilter.class);
	public static final String TYPE = "forgero:similar_block";
	public static final SimilarBlockFilter INSTANCE = new SimilarBlockFilter();
	public static final Codec<SimilarBlockFilter> CODEC = Codec.unit(INSTANCE);
