...
/**
 * The Assembly Station block for disassembling Forgero items into parts.
 * <p>
 * This is a double-wide block that opens a screen handler for breaking down
 * tools and weapons into their component parts.
 */
public class AssemblyStationBlock extends AbstractDoubleBlock {

	private static final Text TITLE = Text.translatable("container.forgero.assembly_station");
	...
	public NamedScreenHandlerFactory createScreenHandlerFactory(BlockState state, World world, BlockPos pos) {
		return new SimpleNamedScreenHandlerFactory((syncId, inventory, player) -> {
			...
			if (services != null) {
				...
				return new AssemblyStationScreenHandler(syncId, inventory, context, ScreenHandlerContext.create(world, pos));
			}
			return new AssemblyStationScreenHandler(syncId, inventory, null, ScreenHandlerContext.create(world, pos));
		}, TITLE);
	}
}
