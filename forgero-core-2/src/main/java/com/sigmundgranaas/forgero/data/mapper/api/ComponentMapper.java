...
import com.sigmundgranaas.forgero.data.loading.api.data.condition.AndPredicateData;
import com.sigmundgranaas.forgero.data.loading.api.data.condition.ConditionData;
import com.sigmundgranaas.forgero.data.loading.api.data.condition.InSlotTypePredicateData;
import com.sigmundgranaas.forgero.data.loading.api.data.condition.NotPredicateData;
import com.sigmundgranaas.forgero.data.loading.api.data.condition.OrPredicateData;
import com.sigmundgranaas.forgero.data.loading.api.data.condition.PredicateData;
import com.sigmundgranaas.forgero.data.loading.api.data.condition.SlotContainsPredicateData;
