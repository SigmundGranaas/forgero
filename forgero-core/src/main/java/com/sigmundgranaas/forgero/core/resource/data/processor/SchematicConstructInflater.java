...
public class SchematicConstructInflater {
    ...
    private Function<String, List<DataResource>> typeFinder;

    private Function<String, Optional<DataResource>> idFinder;

    private Function<String, Optional<DataResource>> templateProvider;
    ...
    private boolean invalidData() {
        return resource.construct().isPresent();
    }
