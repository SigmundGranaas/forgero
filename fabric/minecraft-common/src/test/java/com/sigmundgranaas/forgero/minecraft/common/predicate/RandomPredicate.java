...
import static com.sigmundgranaas.forgero.minecraft.common.match.predicate.RandomPredicate.*;
import static com.sigmundgranaas.forgero.minecraft.common.match.predicate.RandomPredicate.SeedComputations.*;
