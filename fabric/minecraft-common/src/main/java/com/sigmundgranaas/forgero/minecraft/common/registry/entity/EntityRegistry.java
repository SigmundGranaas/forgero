package com.sigmundgranaas.forgero.minecraft.common.registry.entity;
...
public class EntityRegistry {
	...
	public static void register() {
		...
		THROWN_ITEM_ENTITY = Registry.register(
				Registries.ENTITY_TYPE, THROWN_ENTITY_IDENTIFIER,
				EntityType.Builder.create((EntityType<ThrowableItem> entity, World world) -> new ThrowableItem(entity, world),
						SpawnGroup.MISC
				).build(THROWN_ENTITY_IDENTIFIER.toString())
		);
	}
}
