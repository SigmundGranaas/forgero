	...
	private static class MainCategory {
		private static ConfigCategory buildMainCategory() {
			return ConfigCategory.createBuilder().name(Text.translatable("forgero.config.category.main.title")).tooltip(
					...
					ListOption.createBuilder(String.class).name(Text.translatable("forgero.config.disabledResources")).tooltip(
							Text.translatable("forgero.config.disabledResources.tooltip")).initial("").binding(
					...
					).controller(StringController::new).build()).group(
					ListOption.createBuilder(String.class).name(Text.translatable("forgero.config.disabledPacks")).tooltip(
							Text.translatable("forgero.config.disabledPacks.tooltip")).initial("").binding(
							Collections.emptyList(),
					...
					).controller(StringController::new).build()).group(buildRecipesUpgradesAndLootGroup()).group(
					buildRepairingGroup()).group(buildAttributesGroup()).build();
		}

		private static OptionGroup buildRecipesUpgradesAndLootGroup() {
			return OptionGroup.createBuilder().name(Text.translatable("forgero.config.group.recipes_upgrades_and_loot.title")).tooltip(
					Text.translatable("forgero.config.group.recipes_upgrades_and_loot.title.tooltip")).option(
					...
					).controller(BooleanController::new).build()).option(
					Option.createBuilder(Boolean.class).name(Text.translatable("forgero.config.enableCustomRecipeDeletion")).tooltip(
							Text.translatable("forgero.config.enableCustomRecipeDeletion.tooltip")).binding(
							true,
					...
					Option.createBuilder(Boolean.class).name(Text.translatable("forgero.config.enableRecipesForAllSchematics")).tooltip(
							Text.translatable("forgero.config.enableRecipesForAllSchematics.tooltip")).binding(
							false,
					...
					Option.createBuilder(Boolean.class).name(Text.translatable("forgero.config.enableUpgradeInCraftingTable")).tooltip(
							Text.translatable("forgero.config.enableUpgradeInCraftingTable.tooltip")).binding(
							false,
					...
					Option.createBuilder(Boolean.class).name(Text.translatable("forgero.config.disableVanillaLoot")).tooltip(
							Text.translatable("forgero.config.disableVanillaLoot.tooltip")).binding(
							false,
					...
					Option.createBuilder(Boolean.class).name(Text.translatable("forgero.config.disableVanillaTools")).tooltip(
							Text.translatable("forgero.config.disableVanillaTools.tooltip")).binding(
							false,
					...
					).controller(BooleanController::new).build()).option(Option.createBuilder(Boolean.class).name(
					Text.translatable("forgero.config.convertVanillaRecipesToForgeroTools")).tooltip(
					Text.translatable("forgero.config.convertVanillaRecipesToForgeroTools.tooltip")).binding(
					false,
					...
					Option.createBuilder(Boolean.class).name(Text.translatable("forgero.config.convertVanillaToolLoot")).tooltip(
							Text.translatable("forgero.config.convertVanillaToolLoot.tooltip")).binding(
							false,
		...
		private static OptionGroup buildRepairingGroup() {
			return OptionGroup.createBuilder().name(Text.translatable("forgero.config.group.repairing.title")).tooltip(
					Text.translatable("forgero.config.group.repairing.title.tooltip")).option(
					Option.createBuilder(Boolean.class).name(Text.translatable("forgero.config.enableUnbreakableTools")).tooltip(
							Text.translatable("forgero.config.enableUnbreakableTools.tooltip")).binding(
							false,
					...
					Option.createBuilder(Boolean.class).name(Text.translatable("forgero.config.enableRepairKits")).tooltip(
							Text.translatable("forgero.config.enableRepairKits.tooltip")).binding(
							true,
		...
		private static OptionGroup buildAttributesGroup() {
			return OptionGroup.createBuilder().name(Text.translatable("forgero.config.group.attributes.title")).tooltip(
					Text.translatable("forgero.config.group.attributes.title.tooltip")).option(
					Option.createBuilder(Integer.class).name(Text.translatable("forgero.config.baseSoulLevelRequirement")).tooltip(
							Text.translatable("forgero.config.baseSoulLevelRequirement.tooltip")).binding(
							1000,
					...
					).controller(IntegerFieldController::new).build()).option(
					Option.createBuilder(Boolean.class).name(Text.translatable("forgero.config.useEntityAttributes")).tooltip(
							Text.translatable("forgero.config.useEntityAttributes.tooltip")).binding(
							true,
					...
					Option.createBuilder(Boolean.class).name(Text.translatable("forgero.config.showAttributeDifference")).tooltip(
							Text.translatable("forgero.config.showAttributeDifference.tooltip")).binding(
							true,
					...
					Option.createBuilder(Boolean.class).name(Text.translatable("forgero.config.hideRarity")).tooltip(
							Text.translatable("forgero.config.hideRarity.tooltip")).binding(
							true,
							() -> ForgeroConfigurationLoader.configuration.hideRarity,
							newValue -> ForgeroConfigurationLoader.configuration.hideRarity = newValue
					).controller(BooleanController::new).build()).option(
					Option.createBuilder(Boolean.class).name(Text.translatable("forgero.config.weightReducesAttackSpeed")).tooltip(
							Text.translatable("forgero.config.weightReducesAttackSpeed.tooltip")).binding(
							true,
					...
					Option.createBuilder(Float.class).name(Text.translatable("forgero.config.minimumAttackSpeed")).tooltip(
							Text.translatable("forgero.config.minimumAttackSpeed.tooltip")).binding(
							0.5f,
					...
					).controller(FloatFieldController::new).build()).option(
					Option.createBuilder(Boolean.class).name(Text.translatable("forgero.config.weightIncreasesHunger")).tooltip(
							Text.translatable("forgero.config.weightIncreasesHunger.tooltip")).binding(
							false,
					...
					Option.createBuilder(Integer.class).name(Text.translatable("forgero.config.weightIncreasesHungerScalar")).tooltip(
							Text.translatable("forgero.config.weightIncreasesHungerScalar.tooltip")).binding(
							10,
					...
					Option.createBuilder(Float.class).name(Text.translatable("forgero.config.weightIncreasesHungerBaseChance")).tooltip(
							Text.translatable("forgero.config.weightIncreasesHungerBaseChance.tooltip")).binding(
							0.01f,
					...
					Option.createBuilder(Integer.class).name(Text.translatable("forgero.config.weightIncreasesHungerCenterPoint")).tooltip(
							Text.translatable("forgero.config.weightIncreasesHungerCenterPoint.tooltip")).binding(
							50,
					...
					).controller((var option) -> new IntegerSliderController(option, 0, 200, 1)).build()).build();
		}
	}
	...
	private static class DebugCategory {
		private static ConfigCategory buildDebugCategory() {
			return ConfigCategory.createBuilder().name(Text.translatable("forgero.config.category.debug.title")).tooltip(
					...
					OptionGroup.createBuilder().name(Text.translatable("forgero.config.group.debug.title")).tooltip(
							Text.translatable("forgero.config.group.debug.title.tooltip")).option(
							Option.createBuilder(Boolean.class).name(Text.translatable("forgero.config.resourceLogging")).tooltip(
									Text.translatable("forgero.config.resourceLogging.tooltip")).binding(
									true,
							...
							Option.createBuilder(Boolean.class).name(Text.translatable("forgero.config.logDisabledPackages")).tooltip(
									Text.translatable("forgero.config.logDisabledPackages.tooltip")).binding(
									false,
							...
							Option.createBuilder(Boolean.class).name(Text.translatable("forgero.config.exportGeneratedTextures")).tooltip(
									Text.translatable("forgero.config.exportGeneratedTextures.tooltip")).binding(
									false,
							...
							).controller(BooleanController::new).build()).build()).build();
		}
	}
	...
	private static class PerformanceCategory {
		private static ConfigCategory buildPerformanceCategory() {
			return ConfigCategory.createBuilder().name(Text.translatable("forgero.config.category.performance.title")).tooltip(
					...
					OptionGroup.createBuilder().name(Text.translatable("forgero.config.group.performance.title")).tooltip(
							Text.translatable("forgero.config.group.performance.title.tooltip")).option(
							Option.createBuilder(Boolean.class).name(Text.translatable("forgero.config.buildModelsAsync")).tooltip(
									Text.translatable("forgero.config.buildModelsAsync.tooltip")).binding(
									true,
