...
public class HearthBlockSyncS2CPacket {
	private final BlockPos pos;
	private final ItemStack stack;

	public HearthBlockSyncS2CPacket(BlockPos pos, ItemStack stack) {
		this.pos = pos;
		this.stack = stack;
	}
	...
	public static void receive(MinecraftClient client, HearthBlockSyncS2CPacket packet) {
		client.execute(() -> {
	...
	public static void receive(MinecraftClient client, PacketByteBuf buf) {
		...
		receive(client, new HearthBlockSyncS2CPacket(pos, stack));
	}
}
