...
public class SchematicResultUtil {
	public static void openSchematicSelection(PlayerEntity player, BlockPos pos, List<Identifier> options, World world) {
		...
		ServerPlayNetworking.send((net.minecraft.server.network.ServerPlayerEntity) player, ModMessages.OPEN_SCHEMATIC_SELECTION, data);
	}
