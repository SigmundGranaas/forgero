...
import static com.sigmundgranaas.forgero.api.v0.predicate.Registries.*;
import static com.sigmundgranaas.forgero.item.RegistryUtils.defaultItem;
import static com.sigmundgranaas.forgero.item.RegistryUtils.settingProcessor;
import static com.sigmundgranaas.forgero.predicate.block.Adapters.*;
import static com.sigmundgranaas.forgero.predicate.entity.EntityAdapter.*;
...
import com.sigmundgranaas.forgero.feature.BlockEfficiencyFeature;
...
import com.sigmundgranaas.forgero.feature.onhit.entity.OnHitEntityFeature;
import com.sigmundgranaas.forgero.feature.OnUseFeature;
import com.sigmundgranaas.forgero.feature.swinghand.SwingHandFeature;
import com.sigmundgranaas.forgero.handler.afterUse.AfterUseHandler;
import com.sigmundgranaas.forgero.handler.afterUse.ConsumeStackHandler;
import com.sigmundgranaas.forgero.handler.afterUse.ConsumeUpgradeHandler;
import com.sigmundgranaas.forgero.handler.afterUse.CoolDownHandler;
import com.sigmundgranaas.forgero.handler.afterUse.DamageHandler;
...
import com.sigmundgranaas.forgero.handler.blockbreak.filter.FilterWrapper;
...
import com.sigmundgranaas.forgero.handler.entity.FrostHandler;
import com.sigmundgranaas.forgero.handler.entity.FunctionExecuteHandler;
import com.sigmundgranaas.forgero.handler.entity.MagneticHandler;
import com.sigmundgranaas.forgero.handler.entity.ParticleHandler;
import com.sigmundgranaas.forgero.handler.entity.SoundHandler;
import com.sigmundgranaas.forgero.handler.entity.SummonHandler;
...
import com.sigmundgranaas.forgero.handler.use.Consume;
import com.sigmundgranaas.forgero.handler.use.EntityUseHandler;
import com.sigmundgranaas.forgero.handler.use.StopHandler;
import com.sigmundgranaas.forgero.handler.use.ThrowTridentHandler;
import com.sigmundgranaas.forgero.handler.use.ThrowableHandler;
import com.sigmundgranaas.forgero.handler.use.UseHandler;
import com.sigmundgranaas.forgero.item.BuildableStateConverter;
import com.sigmundgranaas.forgero.item.GemItemRegistrar;
import com.sigmundgranaas.forgero.item.ItemRegistries;
import com.sigmundgranaas.forgero.item.RegistryUtils;
import com.sigmundgranaas.forgero.item.tool.DynamicToolItemRegistrationHandler;
import com.sigmundgranaas.forgero.item.tool.DynamicWeaponItemRegistrationHandler;
import com.sigmundgranaas.forgero.match.predicate.DamagePercentagePredicate;
import com.sigmundgranaas.forgero.match.predicate.MatchContextTypePredicate;
import com.sigmundgranaas.forgero.match.predicate.RandomPredicate;
import com.sigmundgranaas.forgero.match.predicate.WeatherPredicate;
...
import com.sigmundgranaas.forgero.predicate.entity.EntityAdapter;
import com.sigmundgranaas.forgero.predicate.entity.EntityPredicate;
import com.sigmundgranaas.forgero.predicate.flag.FlagGroupPredicate;
import com.sigmundgranaas.forgero.predicate.world.DimensionPredicate;
		...
		ResourceManagerHelper.get(ResourceType.SERVER_DATA)
		                     .registerReloadListener(new SimpleSynchronousResourceReloadListener() {
			                     ...
			                     public void reload(ResourceManager manager) {
				                     ...
				                     Gson gson = new Gson();
				                     for (Resource res : manager.findResources(
						                     "leveled_soul_properties", path -> path.getPath().endsWith(".json")).values()) {
					                     try (InputStream stream = res.getInputStream()) {
						                     SoulLevelPropertyData data = gson.fromJson(
								                     new JsonReader(new InputStreamReader(stream)), SoulLevelPropertyData.class);
