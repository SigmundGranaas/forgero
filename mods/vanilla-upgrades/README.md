...
Add upgrade slots to vanilla Minecraft tools, weapons, and armor.

Your diamond sword stays a diamond sword - but now you can add a leather grip or reinforce the blade with blaze powder.
...
Requires Fabric Loader and Fabric API for Minecraft 1.20.1.
...
Pick Vanilla Upgrades if you just want to enhance your regular tools. Pick Forgero if you want a full crafting overhaul.

## Links

- [GitHub](https://github.com/sigmundgranaas/forgero)
- [Issues](https://github.com/sigmundgranaas/forgero/issues)
- [Discord](https://discord.gg/v6sDsftE9N)
