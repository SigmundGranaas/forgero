...
import static com.sigmundgranaas.forgero.testutil.Schematics.PICKAXE_HEAD_SCHEMATIC;
...
import com.sigmundgranaas.forgero.testutil.Conditions;
...
class DeterministicHashCodeStateTest {
	...
	void schematicPartHashCode() {
		var defaultState = ConstructedSchematicPart.SchematicPartBuilder
				...
				.conditions(List.of(Conditions.SHARP))
