...
import com.sigmundgranaas.forgerofabric.resources.loader.ModContainerFileLoader;
...
public record ModContainerService() {
    ...
    public List<com.sigmundgranaas.forgerofabric.resources.loader.ModContainerFileLoader> getForgeroResourceContainers() {
