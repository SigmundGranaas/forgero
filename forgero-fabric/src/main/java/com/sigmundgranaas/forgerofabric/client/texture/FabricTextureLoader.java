package com.sigmundgranaas.forgerofabric.client.texture;
...
public class FabricTextureLoader implements TextureLoader {
    ...
    private final com.sigmundgranaas.forgerofabric.resources.FileService fileService;
    ...
    public Texture getResource(TextureIdentifier id) {
        try {
            ...
            Forgero.LOGGER.error("Unable to load {} due to {}, Falling back to default image", id.getFileNameWithExtension(), e);
    ...
    public Texture getResource(PaletteIdentifier id) {
        try {
            ...
            Forgero.LOGGER.error("Unable to load {} palette due to {}, Falling back to default image", id.getIdentifier(), e);
            return new RawTexture(id, new BufferedImage(32, 32, BufferedImage.TYPE_INT_BGR));
        }
    }
