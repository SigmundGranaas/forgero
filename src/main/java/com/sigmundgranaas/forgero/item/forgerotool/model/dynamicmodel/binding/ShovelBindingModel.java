...
public class ShovelBindingModel extends AbstractDynamicModel {
    ...
    public ShovelBindingModel(ForgeroToolPartItem toolpartItem) {
        super(toolpartItem);
    }

    @Override
    public ModelIdentifier getModelIdentifier() {
        return new ModelIdentifier(Forgero.MOD_NAMESPACE, getToolpart().getToolPartTypeAndMaterialLowerCase() + "_shovel", "inventory");
    }
