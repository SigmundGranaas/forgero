...
public class PickaxeItem extends net.minecraft.item.PickaxeItem implements ForgeroToolItem {
    private final ForgeroTool tool;

    public PickaxeItem(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings, ForgeroTool tool) {
