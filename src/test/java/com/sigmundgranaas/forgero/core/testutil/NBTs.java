...
public class NBTs {
    ...
    private static NbtCompound handle() {
        ...
        compound.putString(NAME_IDENTIFIER, "oak-handle");
        compound.putString(ID_IDENTIFIER, "forgero#oak-handle");
    ...
    private static NbtCompound pickaxeHead() {
        var compound = new NbtCompound();
        compound.putString(NAME_IDENTIFIER, "iron-pickaxe_head");
        compound.putString(ID_IDENTIFIER, "forgero#iron-pickaxe_head");
    ...
    private static NbtCompound binding() {
        var compound = new NbtCompound();
        compound.putString(NAME_IDENTIFIER, "iron-binding");
        compound.putString(ID_IDENTIFIER, "forgero#iron-binding");
        compound.putString(STATE_TYPE_IDENTIFIER, COMPOSITE_IDENTIFIER);
        NbtList ingredients = new NbtList();
        ingredients.add(iron());
    ...
    private static NbtCompound pickaxe() {
        var compound = new NbtCompound();
        compound.putString(NAME_IDENTIFIER, "iron-pickaxe");
        compound.putString(ID_IDENTIFIER, "forgero#iron-pickaxe");
        compound.putString(STATE_TYPE_IDENTIFIER, COMPOSITE_IDENTIFIER);
    ...
    private static NbtCompound oak() {
        var compound = new NbtCompound();
        compound.putString(NAME_IDENTIFIER, "oak");
        compound.putString(ID_IDENTIFIER, "forgero#oak");
        compound.putString(STATE_TYPE_IDENTIFIER, INGREDIENT_IDENTIFIER);
        return compound;
    }
    ...
    private static NbtCompound iron() {
        var compound = new NbtCompound();
        compound.putString(NAME_IDENTIFIER, "iron");
        compound.putString(ID_IDENTIFIER, "forgero#iron");
        compound.putString(STATE_TYPE_IDENTIFIER, INGREDIENT_IDENTIFIER);
        return compound;
    }
    ...
    private static NbtCompound pickaxeHeadSchematic() {
        var compound = new NbtCompound();
        compound.putString(NAME_IDENTIFIER, "pickaxe_head-schematic");
        compound.putString(ID_IDENTIFIER, "forgero#pickaxe_head-schematic");
        compound.putString(STATE_TYPE_IDENTIFIER, INGREDIENT_IDENTIFIER);
        return compound;
    }
    ...
    private static NbtCompound bindingSchematic() {
        var compound = new NbtCompound();
        compound.putString(NAME_IDENTIFIER, "binding-schematic");
        compound.putString(ID_IDENTIFIER, "forgero#binding-schematic");
        compound.putString(STATE_TYPE_IDENTIFIER, INGREDIENT_IDENTIFIER);
        return compound;
    }
